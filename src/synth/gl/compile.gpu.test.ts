...
describe('synth/gl assemblePatch GPU compile', () => {
  ...
  // 66 generators → hundreds of combination patches; default 5s testTimeout is too short.
  ...
  it(
    ...
    async () => {
      ...
      // catalog size sanity: 66 generators
      expect(inlineCatalog.all().length).toBe(66);
